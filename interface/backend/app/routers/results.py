...
from app.services.results_timeseries import (
    TimeseriesData,
    generate_mock_timeseries as _generate_mock_timeseries,
    load_real_timeseries as _load_real_timeseries,
)
...
# Response models (TimeseriesPoint/TimeseriesData now live in services.results_timeseries)
