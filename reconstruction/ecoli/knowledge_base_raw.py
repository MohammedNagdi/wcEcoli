...
LIST_OF_DICT_FILENAMES = [
	...
	os.path.join("condition", "media", "MIX0-57-GLC-20mM.tsv"),
	os.path.join("condition", "media", "MIX0-57-GLC-5mM.tsv"),
	os.path.join("condition", "media", "MIX0-57-GLC-2mM.tsv"),
